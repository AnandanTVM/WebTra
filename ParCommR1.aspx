<%@ Page Title="" Language="C#" MasterPageFile="~/Parents.master" AutoEventWireup="true" CodeFile="ParCommR1.aspx.cs" Inherits="ParCommR1" %>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="cid" 
                            DataNavigateUrlFormatString="ParCommR2.aspx?{0}" DataTextField="cid" 

<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor.master" AutoEventWireup="true" CodeFile="DocAddSuggestion.aspx.cs" Inherits="DocAddSuggestion" %>
...
<table align="center" cellpadding="0" class="style1" 
        ...
        <tr>
            ...
            <td class="style6">
                <asp:Button ID="Button2" runat="server" Text="Update Suggestion" Width="156px" 

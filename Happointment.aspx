<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="Happointment.aspx.cs" Inherits="Happointment" %>
    ...
    <table align="center" cellpadding="0" class="style1" 
        ...
        <tr>
            ...
            <td class="style4" colspan="2" valign="middle">
                <asp:TextBox ID="na" runat="server" Height="30px" Width="225px"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td class="style3" valign="middle">
                Department</td>
            <td class="style4" colspan="2" valign="middle">
                <asp:TextBox ID="de" runat="server" Height="30px" Width="225px"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ControlToValidate="de" ErrorMessage="Department" ForeColor="Red" 

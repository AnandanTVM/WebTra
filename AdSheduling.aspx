<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AdSheduling.aspx.cs" Inherits="AdSheduling" %>
...
<table align="center" cellpadding="0" class="style1" 
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                    ControlToValidate="TextBox1" ErrorMessage="Alloted area pls" ForeColor="Red" 
        ...
        <tr>
            <td class="style1">
                &nbsp;</td>
            <td class="style3" valign="middle">
                Current Working Doctor Info</td>
            <td class="style4" colspan="2" valign="middle">
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                    ControlToValidate="TextBox4" ErrorMessage="Messeage Pls" ForeColor="Red" 
                    SetFocusOnError="True">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td class="style10">
                &nbsp;</td>
            <td class="style6">
                <asp:Button ID="Button2" runat="server" Text="Shedule" Width="88px" 

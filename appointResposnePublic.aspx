<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="appointResposnePublic.aspx.cs" Inherits="appointResposnePublic" %>
    ...
    <table align="center" cellpadding="0" class="style1" 
        ...
        <tr>
            ...
            <td class="style3" valign="middle">
                Your Name</td>
            <td class="style4" colspan="2" valign="middle">
                <asp:TextBox ID="yn" runat="server" Height="30px" Width="225px"></asp:TextBox>
            </td>
            <td>
                &nbsp;</td>
        </tr>

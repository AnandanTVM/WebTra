<%@ Page Title="" Language="C#" MasterPageFile="~/Nurse.master" AutoEventWireup="true" CodeFile="DoUpdateTestResult.aspx.cs" Inherits="DoUpdateTestResult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" cellpadding="0" class="style1" 
        ...
        <tr>
            ...
            <td class="style6">
                <asp:Button ID="Button2" runat="server" Text="Update Test Result" Width="206px" 
